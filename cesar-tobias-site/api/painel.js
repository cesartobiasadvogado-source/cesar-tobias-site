...
module.exports = async (req, res) => {
  ...
  if (acao === 'executar') {
    ...
    var camposPermitidos = ['tipo', 'nome', 'tipo_servico', 'descricao', 'endereco', 'etapa', 'origem', 'midia', 'campanha', 'resposta', 'valor', 'vencimento', 'entrada', 'parcelas', 'data_entrada', 'dia_vencimento', 'percentual_honorarios', 'percentual_recursal', 'campos_extra'];
